    ...
    public ArrayList<Revista> readArticlesFile(String filename)
        ...
        while ((linea = br.readLine()) != null) {
            ...
            try {
                ...
                // TODO -> Crear un objecte Article afegint com autor l'element idAutor de la llista d'autors.txt
                Article article = new Article(idArticle, titol, data_creacio, publicable, llistaAutors.get(idAutor-1));

                // TODO -> incorporar l'article a la revista indicada per idRevista dins
                // la llista de revistes.txt
                llistaRevistes.get(idRevista-1).addArticle(article);
                // TODO
                // Cal afegir un objecte Magazine a la llista
